...
- `Math`: Add `add512`, `mul512` and `mulShr`. ([#5035](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5035))
...
- `Math`: Add saturating arithmetic operations `saturatingAdd`, `saturatingSub` and `saturatingMul`. ([#5527](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5527))
...
- `Initializable`: Add `_initializableStorageSlot` function that returns a pointer to the storage struct. The function allows customizing with a custom storage slot with an `override`. ([#5337](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5337))
- `GovernorSuperQuorum`: Add a governance extension to support a super quorum. Proposals that meet the super quorum (and have a majority of for votes) advance to the `Succeeded` state before the proposal deadline. ([#5492](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5492))
...
- `MerkleTree`: Add an update function that replaces a previously inserted leaf with a new value, updating the tree root along the way. ([#5453](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5453))
- `TimelockController`: Receive function is now virtual. ([#5506](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5506))
...
- `Strings`: Add `espaceJSON` that escapes special characters in JSON strings. ([#5508](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5508))
- `GovernorVotesSuperQuorumFraction`: Add a variant of the `GovernorSuperQuorum` extensions where the super quorum is expressed as a fraction of the total supply. ([#5492](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5492))
...
- `MessageHashUtils`: Add `toDataWithIntendedValidatorHash(address, bytes32)`. ([#5081](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/5081))
